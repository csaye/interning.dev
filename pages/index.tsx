...
export default function Index() {
  ...
  const [selectedColor, setSelectedColor] = useState("#999999"); // adding color
  ...
  useEffect(() => {
    ...
    setSelectedColor(window.localStorage.getItem("selectedColor") || "#999");
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className={styles.filters}>
        ...
        />
        <label>
          Select a color for checked rows:{"  "}
          <input
            ...
            onChange={(event) => {
              ...
              window.localStorage.setItem("selectedColor", event.target.value);
            }}
          />
        </label>
      </div>
          ...
          {filteredInternships.map((internship, i) => (
            <div
              className={`${styles.row} ${
                internship.applied ? styles.checkedRow : ""
              }`}
              key={i}
              style={
                internship.applied ? { backgroundColor: selectedColor } : {}
              }
            >
